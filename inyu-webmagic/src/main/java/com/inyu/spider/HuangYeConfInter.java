...
public class HuangYeConfInter {
     ...
     //
    private static  final String baseUrl = "https://www.11467.com/guangzhou/co/428380.htm";

   public static boolean  getPageInfo() throws IOException {
        HttpUriRequest postRequestParams = getPostRequestParams();

        String ret = HttpUtils.sendGet(baseUrl,null);
     ...
     private static HttpUriRequest getPostRequestParams() {
          HttpUriRequest httpUriRequest = new HttpPost(baseUrl);
          // 添加必要的头信息
          int index =Integer.parseInt(Math.random()*15+"");
          ...
          httpUriRequest.setHeader("Host", "www.11467.com");
          httpUriRequest.setHeader("Cache-Control", "max-age=0");
          httpUriRequest.setHeader("Referer", "https://b2b.11467.com/search/4029.htm  ");
          httpUriRequest.setHeader("Upgrade-Insecure-Requests", "1");
          httpUriRequest.setHeader("Connection", "keep-alive");
          httpUriRequest.setHeader("Content-Type", "application/x-www-form-urlencoded");
          // 模拟浏览器，否则服务器限制访问
          httpUriRequest.setHeader("User-Agent", USER_AGENTS[index]);
